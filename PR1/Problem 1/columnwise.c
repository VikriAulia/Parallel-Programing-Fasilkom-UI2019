/* Matrix vector multiplication (column-wise) Author: 
yohanes.gultom@gmail.com Baseline: 
http://sites.google.com/site/heshanhome/resources/MPI_matrix_multiplication.c 
*/
#include "stdio.h"
# include "stdlib.h" 
#include "mpi.h"
...
void multiply_two_arrays(int NRA, int NCA, int NCB, int numworkers, int procid) {
    ...
    avecol, extra, offset,i, j, k, n, count;
