/** source: 
https://paralelos2008.googlecode.com/svn-history/r57/trunk/MPI-Paralelos/MPI-Paralelos/CANNON-MPI.c 
**/
...
int main(int argc, char** argv) {
  ...
  if(mi_id == 0)
  {
    ...
    una parte de A y B que es la que les corresponde, enviamos a cada 
uno ya con la distribuci�n
